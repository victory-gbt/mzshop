  ...
  <div>
    ...
    <div v-if="shopcartData.length > 0" class="shopcart-wrapper">
      ...
      <div class="clearfix shopcart-footer">
        ...
        <div class="fr">
          <span>已优惠<span class="footer-number red">0.00</span>元，合计(不含运费)：<span class="footer-total red footer-number">￥{{checkedGoodsPrice}}</span></span>
    ...
    <div v-else class="shopcart-empty">
      ...
      <div class="empty-right">
        <p class="empty-desc">购物车内还没有商品，赶快去选购吧~</p>
